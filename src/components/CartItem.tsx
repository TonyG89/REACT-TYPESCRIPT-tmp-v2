...
const CartItemBlock: React.FC<CartItem> = (props) => {
    const { title, id, link = 0, brand, size, price, category = "clothes", count } = props
    const dispatch = useDispatch()

    const onClickPlus = () => dispatch(addItem(props as CartItem))
